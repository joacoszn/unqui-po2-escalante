...
class PlantaPermanente extends Empleado {
	...
	public PlantaPermanente(String nombre, Integer dni, String direccion, String estadoCivil, LocalDate fechaNacimiento,
...
class PlantaTemporaria extends Empleado {
	...
	public PlantaTemporaria(String nombre, Integer dni, String direccion, String estadoCivil, LocalDate fechaNacimiento,
			Double sueldoBasico) {
		this.nombre = nombre;
		this.dni = dni;
		this.direccion = direccion;
...
class Contratado extends Empleado {
	...
	public Contratado(String nombre, Integer dni, String direccion, String estadoCivil, LocalDate fechaNacimiento,
